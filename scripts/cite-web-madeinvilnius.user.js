// ==UserScript==
// @name        MADEINVILNIUS.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from madeinvilnius.lt articles
// @match       https://madeinvilnius.lt/*
// @match       https://www.madeinvilnius.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://madeinvilnius.lt/wp-content/uploads/2025/02/made-in-vilnius-icon-150x150.png
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-madeinvilnius.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-madeinvilnius.user.js
