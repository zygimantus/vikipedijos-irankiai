// ==UserScript==
// @name        SANTARVE.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from santarve.lt articles
// @match       https://santarve.lt/*
// @match       https://www.santarve.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.santarve.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-santarve.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-santarve.user.js
