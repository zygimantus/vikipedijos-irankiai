// ==UserScript==
// @name        INFO.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from info.lt articles
// @match       https://info.lt/*
// @match       https://www.info.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.info.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-info.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-info.user.js
