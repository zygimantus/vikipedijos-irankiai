// ==UserScript==
// @name        RESPUBLIKA.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from respublika.lt articles
// @match       https://respublika.lt/*
// @match       https://www.respublika.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.respublika.lt/favicon-192x192.png
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-respublika.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-respublika.user.js
...
generate({
  ...
  publisher: '[[Respublika (dienraštis)]]',
