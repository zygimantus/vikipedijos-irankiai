// ==UserScript==
// @name        VILNIAUSKRASTAS.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from vilniauskrastas.lt articles
// @match       https://vilniauskrastas.lt/*
// @match       https://www.vilniauskrastas.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.vilniauskrastas.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-vilniauskrastas.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-vilniauskrastas.user.js
