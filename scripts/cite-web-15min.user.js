// ==UserScript==
// @name        15MIN.LT Citation Generator for Wikipedia
...
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-15min.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-15min.user.js
...
generate({
  title: '.article-top h1',
  date: '.article-top .date .publish',
  dateFormat: raw => raw.replace(/\./g, '-').replace(/\s+/g, '-'),
  author: '.author-info span',
  agency: '.article-source .source-name-description a',
  publisher: '[[15min]]',
  website: '15min.lt',
  refName: '15min'
});
