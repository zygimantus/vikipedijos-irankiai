// ==UserScript==
// @name        KURJERIS.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from kurjeris.lt articles
// @match       https://kurjeris.lt/*
// @match       https://www.kurjeris.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.kurjeris.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-kurjeris.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-kurjeris.user.js
