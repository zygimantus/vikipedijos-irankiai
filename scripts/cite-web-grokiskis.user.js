// ==UserScript==
// @name        GROKISKIS.LT Citation Generator for Wikipedia
...
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.grokiskis.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-grokiskis.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-grokiskis.user.js
...
generate({
  title: '.td-post-header h1.entry-title',
  date: '.td-post-date',
  dateFormat: raw => {
  ...
  publisher: '[[Gimtasis Rokiškis]]',
  website: 'grokiskis.lt',
  refName: 'grokiskis'
});
