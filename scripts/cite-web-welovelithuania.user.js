// ==UserScript==
// @name        WELOVELITHUANIA.COM Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from welovelithuania.com articles
// @match       https://welovelithuania.com/*
// @match       https://www.welovelithuania.com/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.welovelithuania.com/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-welovelithuania.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-welovelithuania.user.js
...
generate({
  ...
  website: 'welovelithuania.com',
  refName: 'welovelithuania'
});
