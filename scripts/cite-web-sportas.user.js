// ==UserScript==
// @name        SPORTAS.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from sportas.lt articles
// @match       https://sportas.lt/*
// @match       https://www.sportas.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://zygimantus.github.io/vikipedijos-irankiai/favicon/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-sportas.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-sportas.user.js
...
generate({
  title: '.cont_title > h1 > span',
  date: () => {
    var _document$querySelect;
    return (_document$querySelect = document.querySelector('meta[property="publish_time"]')) == null ? void 0 : _document$querySelect.getAttribute('content');
  },
