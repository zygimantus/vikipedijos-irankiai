// ==UserScript==
// @name        GZEME.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from gzeme.lt articles
// @match       https://gzeme.lt/*
// @match       https://www.gzeme.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.gzeme.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-gzeme.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-gzeme.user.js
...
generate({
  ...
  author: '.article__content p > strong',
  publisher: '[[Gimtoji žemė]]',
  website: 'gzeme.lt',
  refName: 'gzeme'
});
