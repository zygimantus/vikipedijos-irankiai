// ==UserScript==
// @name        KVR.KPD.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from kvr.kpd.lt articles
// @match       https://kvr.kpd.lt/*
// @match       https://www.kvr.kpd.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://kvr.kpd.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-kvr.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-kvr.user.js
