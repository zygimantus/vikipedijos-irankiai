// ==UserScript==
// @name        SUDUVOSGIDAS.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from suduvosgidas.lt articles
// @match       https://suduvosgidas.lt/*
// @match       https://www.suduvosgidas.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.suduvosgidas.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-suduvosgidas.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-suduvosgidas.user.js
...
generate({
  ...
  publisher: 'Sūduvos gidas',
  website: 'suduvosgidas.lt',
  refName: 'suduvosgidas'
});
