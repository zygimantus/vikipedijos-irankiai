// ==UserScript==
// @name        INFOLEX.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from infolex.lt articles
// @match       https://infolex.lt/*
// @match       https://www.infolex.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.infolex.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-infolex.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-infolex.user.js
