// ==UserScript==
// @name        PASAULIOLIETUVIS.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from pasauliolietuvis.lt articles
// @match       https://pasauliolietuvis.lt/*
// @match       https://www.pasauliolietuvis.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.pasauliolietuvis.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-pasauliolietuvis.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-pasauliolietuvis.user.js
