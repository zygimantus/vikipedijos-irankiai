// ==UserScript==
// @name        KALVOTOJI.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from kalvotoji.lt articles
// @match       https://kalvotoji.lt/*
// @match       https://www.kalvotoji.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.kalvotoji.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-kalvotoji.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-kalvotoji.user.js
...
generate({
  ...
  publisher: '[[Kalvotoji Žemaitija]]',
  website: 'kalvotoji.lt',
  refName: 'kalvotoji'
});
