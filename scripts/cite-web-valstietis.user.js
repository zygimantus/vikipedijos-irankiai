// ==UserScript==
// @name        VALSTIETIS.LT Citation Generator for Wikipedia
...
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-valstietis.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-valstietis.user.js
...
generate({
  title: '#topPavadinimas',
  date: '#autoriusPublishDate span:nth-of-type(2)',
  dateFormat: d => d.split(' ')[0],
  publisher: '[[Valstietis.lt]]',
  website: 'valstietis.lt',
  refName: 'valstietis',
  delay: 1500
});
