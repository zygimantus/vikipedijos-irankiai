// ==UserScript==
// @name        KAUNAS.KASVYKSTA.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from kaunas.kasvyksta.lt articles
// @match       https://kaunas.kasvyksta.lt/*
...
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-kasvyksta.user.js
...
generate({
  ...
  date: () => {
    ...
    return (_document$querySelect2 = document.querySelector('meta[name="article:published_time"]')) == null ? void 0 : _document$querySelect2.getAttribute('content');
  },
