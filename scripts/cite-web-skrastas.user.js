// ==UserScript==
// @name        SKRASTAS.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from skrastas.lt articles
// @match       https://skrastas.lt/*
// @match       https://www.skrastas.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://zygimantus.github.io/vikipedijos-irankiai/favicon/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-skrastas.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-skrastas.user.js
