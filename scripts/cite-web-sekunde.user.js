// ==UserScript==
// @name        SEKUNDE.LT Citation Generator for Wikipedia
...
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-sekunde.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-sekunde.user.js
...
generate({
  title: '.title',
  date: '.article-info.cf li:nth-child(3)',
  dateFormat: raw => {
    const [datePart] = raw.split(/\s+/);
    const [year, month, day] = datePart.split('.');
    return `${year}-${month.padStart(2, '0')}-${day.padStart(2, '0')}`;
  },
  publisher: '[[Sekundė (laikraštis)|Sekundė]]',
  website: 'sekunde.lt',
  refName: 'sekunde'
});
