// ==UserScript==
// @name        SC.BNS.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from sc.bns.lt articles
// @match       https://sc.bns.lt/*
// @match       https://www.sc.bns.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://sc.bns.lt/favicon.ico?v=1
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-bns.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-bns.user.js
