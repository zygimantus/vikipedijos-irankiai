// ==UserScript==
// @name        ANYKSTENAI.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from anykstenai.lt articles
// @match       https://anykstenai.lt/*
...
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-anykstenai.user.js
...
generate({
  title: 'table[width="779"] font strong',
  date: 'table[align="center"] td font[color="#666666"] strong',
  publisher: () => {
    const url = window.location.href;
    if (url.includes('/asmenys/')) return 'Anykštėnų biografijų žinynas';
    if (url.includes('/vietoves/')) return 'Anykštėnų krašto vietovių žinynas';
    return 'Pasaulio anykštėnų bendrija';
  },
  website: 'anykstenai.lt',
  refName: 'anykstenai'
});
