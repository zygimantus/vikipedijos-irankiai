// ==UserScript==
// @name        JP.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from jp.lt articles
// @match       https://jp.lt/*
// @match       https://www.jp.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://www.jp.lt/favicon.ico
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-jp.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-jp.user.js
