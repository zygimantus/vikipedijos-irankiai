// ==UserScript==
// @name        KLAIPEDA.DIENA.LT Citation Generator for Wikipedia
// @namespace   https://github.com/zygimantus/vikipedijos-irankiai
// @description Generates Wikipedia {{cite web}} references automatically from klaipeda.diena.lt articles
// @match       https://klaipeda.diena.lt/*
// @match       https://www.klaipeda.diena.lt/*
// @version     1.0.0
// @author      Zygimantus
// @icon        https://klaipeda.diena.lt/themes/custom/dienalt-custom-theme/build/assets/icons/favicons/3/favicon.svg
// @run-at      document-end
// @noframes    
// @downloadURL https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-klaipeda-diena.user.js
// @updateURL   https://zygimantus.github.io/vikipedijos-irankiai/scripts/cite-web-klaipeda-diena.user.js
...
generate({
  ...
  publisher: '[[Klaipėda (dienraštis)|Klaipėda]]',
  website: 'klaipeda.diena.lt',
  refName: 'klaipeda-diena'
});
